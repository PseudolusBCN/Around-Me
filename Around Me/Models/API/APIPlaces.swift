...
class APIPlaceGeometry: Decodable {
...
class APIPlaceViewport: Decodable {
...
class APIPlaceLocation: Decodable {
    var lat: Double!
    var lng: Double!
...
class APIPlaceOpeningHours: Decodable {
...
class APIPlacePlusCode: Decodable {
